...
def run_non_interactive_analysis(args, settings):
    ...
    total_size = 0
    final_answer = ""
    # Create a single timestamp for all potential log entries in this run
    ...
    # --- STRATEGY 1: Small files, single-pass (existing logic) ---
    ...
    # --- STRATEGY 2: Large files, multi-pass ---
        ...
        # === PASS 1: MAPPING (Robust logic remains the same) ===
